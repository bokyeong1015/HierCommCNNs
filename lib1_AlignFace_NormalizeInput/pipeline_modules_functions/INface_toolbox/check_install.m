% This scripts checks the installation of the INface toolbox v2.1. 
% 
% All this script does is running a test using all (or at least most) of the 
% functions featured in the INface toolbox v2.1. You can run this script to 
...
disp('Testing independant functions from "photometric" folder. This may take a while.')
...
try
  ...
  if(ok)
    report.msg{report.test_no} = 'Function "retina_model" is working properly.';
    report.ok(report.test_no)  = 1;
  else
    report.msg{report.test_no} = 'Function "retina_model" is NOT working properly.';
    report.ok(report.test_no)  = 0;    
  end
catch
  report.msg{report.test_no} = 'Function "retina_model" is NOT working properly.';
